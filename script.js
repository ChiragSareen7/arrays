...
let myFavSuperheroes=["dad","thor","spider-man","Iron-man","loki"];
...
myFavSuperheroes[myFavSuperheroes.length-2]="chirag";
...
myFavSuperheroes.splice(2,0,"aryan");
console.log(myFavSuperheroes);
...
myFavSuperheroes.splice(3,2,"manik");
console.log(myFavSuperheroes);
...
let dc=["Wonder-Women","Batman","Superman"];
var superheroUniverse=[...marvel,...dc];
...
console.log(superheroUniverse[5]);